...
class GenerationMixin:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        is_dola_gen_mode = dola_decoding is True
        is_greedy_gen_mode = (
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        lm_ids = torch.ones((input_ids.shape[0], 1), dtype=torch.long, device=input_ids.device) * self.config.bos_token_id
        ...
        while True:
            ...
            if lm_weight != 0:
                ...
                lm_logprob = torch.log(nn.functional.softmax(lm_score, dim=-1))
                ...
                lm_logprob = lm_logprob * weights.unsqueeze(1)
                next_tokens_scores = torch.log(next_tokens_probs) + lm_logprob # (lm_weight + 1)*next_token_logits - lm_weight*lm_score
                # next_tokens_scores = logits_processor(input_ids, next_token_logits)
    ...
    def soft_greedy_search_with_biases(
        ...
        **model_kwargs,
        ...
        len_logits_processor = len_logits_processor if len_logits_processor is not None else LogitsProcessorList(
            [
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if lm_weight > 0:
                ...
                next_token_logits = (lm_weight + 1)*next_token_logits - lm_weight*lm_score
